...
let userId = "electricErick";
let currentGithub = "electricErick";
const messageService = new MessageService("electric");

window.addEventListener("load", function () {
  document.getElementById("greeting").innerHTML = `Welcome ${userId}!`;

  //event listener for submit click;
  document.getElementById("submit").addEventListener("click", createFormListener);
